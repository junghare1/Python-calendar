...
#         # Display new calendar
#         for week in cal_content:
#             for day in week:
#                 if day != 0:
#                     if calendar.weekday(year, month, day) == 6:  # Sunday
#                         label = tk.Label(self.calendar_frame, text=str(day), font=("Courier", 12), bg="#f0f0f0", fg="red")
#                     else:
#                         label = tk.Label(self.calendar_frame, text=str(day), font=("Courier", 12), bg="#f0f0f0", fg="#333")
#                     label.grid(row=cal_content.index(week), column=week.index(day), padx=5, pady=5)
